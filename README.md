...
- 电量可读取时显示，无法读取时自然隐藏。
- 服务器、等级、职业使用莓红、琥珀、冷蓝属性签；姓名与家族各占蓝色铭牌的一半。
- 姓名与家族各预留 6 个字符，等级支持到 `LV.999`，职业支持 5 个字符。
...
本项目基于 [FoloToy 官方 ai-passport 仓库](https://gitee.com/FoloToy/ai-passport)开发。代码沿用仓库的 MIT License；字体与角色素材的来源、哈希和许可信息记录在对应的 [`manifest.json`](assets/images/maple-avatar/build-5293/manifest.json) 与资源说明中。
