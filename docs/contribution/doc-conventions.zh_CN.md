...
- fork 所有者可以明确选择一个位于仓库根目录的纯中文普通文件：`README.md`。这个窄范围入口例外不适用于符号链接或嵌套文档，也不会跳过链接、敏感信息或冲突标记检查。
...
- 仓库根目录仅保留工具发现入口（`AGENTS.md`、`CLAUDE.md` 及其翻译）、可选的 fork README 配对或明确选择的纯中文 fork README、许可证、构建清单和 ESP-IDF 配置。
